-- ============================================================
-- Colombo Taxi Rides Inference Dataset Schema
-- Adapted for Sri Lanka (City of Colombo)
-- Out-of-sample inference dataset: year 2025
--
...
CREATE TABLE colombo_taxi_rides_inference (
...
CREATE INDEX idx_colombo_taxi_inference_datetime  ON colombo_taxi_rides_inference (datetime);
CREATE INDEX idx_colombo_taxi_inference_season    ON colombo_taxi_rides_inference (season);
CREATE INDEX idx_colombo_taxi_inference_hour      ON colombo_taxi_rides_inference (hour);
